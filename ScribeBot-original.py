...
craft = 'grindScroll' #This sets the crafting mode. Options (case sensitive): fullSpellBook, grindScroll, fillFromContainer, runebook. 
...
while True:
    ...
    if craft == 'grindScroll':
        gumpNo = [107]
        while True:
            makeScrolls(gumpNo, [], 4, 11, False, False)#(gumpNo, lisscrolls, circle, manacost, spellbook, checkfail)
            item = Items.FindByID(0x1F4C,0x0000,Player.Backpack.Serial)
